...
func init() {
	file_artela_crypto_ethsecp256k1_keys_proto_init()
	md_PubKey = File_artela_crypto_ethsecp256k1_keys_proto.Messages().ByName("PubKey")
...
func (x *PubKey) slowProtoReflect() protoreflect.Message {
	mi := &file_artela_crypto_ethsecp256k1_keys_proto_msgTypes[0]
...
func (x *fastReflection_PubKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "artela.crypto.ethsecp256k1.PubKey.key":
		return len(x.Key) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: artela.crypto.ethsecp256k1.PubKey"))
		}
		panic(fmt.Errorf("message artela.crypto.ethsecp256k1.PubKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PubKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message artela.crypto.ethsecp256k1.PubKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PubKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "artela.crypto.ethsecp256k1.PubKey.key":
		panic(fmt.Errorf("field key of message artela.crypto.ethsecp256k1.PubKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: artela.crypto.ethsecp256k1.PubKey"))
		}
...
func (x *fastReflection_PubKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in artela.crypto.ethsecp256k1.PubKey", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_artela_crypto_ethsecp256k1_keys_proto_init()
	md_PrivKey = File_artela_crypto_ethsecp256k1_keys_proto.Messages().ByName("PrivKey")
...
func (x *PrivKey) slowProtoReflect() protoreflect.Message {
	mi := &file_artela_crypto_ethsecp256k1_keys_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_PrivKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "artela.crypto.ethsecp256k1.PrivKey.key":
		return len(x.Key) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: artela.crypto.ethsecp256k1.PrivKey"))
		}
		panic(fmt.Errorf("message artela.crypto.ethsecp256k1.PrivKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PrivKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message artela.crypto.ethsecp256k1.PrivKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PrivKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "artela.crypto.ethsecp256k1.PrivKey.key":
		panic(fmt.Errorf("field key of message artela.crypto.ethsecp256k1.PrivKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: artela.crypto.ethsecp256k1.PrivKey"))
		}
...
func (x *fastReflection_PrivKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in artela.crypto.ethsecp256k1.PrivKey", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: artela/crypto/ethsecp256k1/keys.proto
...
func (*PubKey) Descriptor() ([]byte, []int) {
	return file_artela_crypto_ethsecp256k1_keys_proto_rawDescGZIP(), []int{0}
}
...
func (*PrivKey) Descriptor() ([]byte, []int) {
	return file_artela_crypto_ethsecp256k1_keys_proto_rawDescGZIP(), []int{1}
}
...
var File_artela_crypto_ethsecp256k1_keys_proto protoreflect.FileDescriptor

var file_artela_crypto_ethsecp256k1_keys_proto_rawDesc = []byte{
	0x0a, 0x25, 0x61, 0x72, 0x74, 0x65, 0x6c, 0x61, 0x2f, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x2f,
	0x65, 0x74, 0x68, 0x73, 0x65, 0x63, 0x70, 0x32, 0x35, 0x36, 0x6b, 0x31, 0x2f, 0x6b, 0x65, 0x79,
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1a, 0x61, 0x72, 0x74, 0x65, 0x6c, 0x61, 0x2e,
	...
	0x2e, 0x61, 0x72, 0x74, 0x65, 0x6c, 0x61, 0x2e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x2e, 0x65,
	...
	0x61, 0x2f, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x2f, 0x65, 0x74, 0x68, 0x73, 0x65, 0x63, 0x70,
	0x32, 0x35, 0x36, 0x6b, 0x31, 0xa2, 0x02, 0x03, 0x41, 0x43, 0x45, 0xaa, 0x02, 0x1a, 0x41, 0x72,
	0x74, 0x65, 0x6c, 0x61, 0x2e, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x2e, 0x45, 0x74, 0x68, 0x73,
	0x65, 0x63, 0x70, 0x32, 0x35, 0x36, 0x6b, 0x31, 0xca, 0x02, 0x1a, 0x41, 0x72, 0x74, 0x65, 0x6c,
	0x61, 0x5c, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x5c, 0x45, 0x74, 0x68, 0x73, 0x65, 0x63, 0x70,
	0x32, 0x35, 0x36, 0x6b, 0x31, 0xe2, 0x02, 0x26, 0x41, 0x72, 0x74, 0x65, 0x6c, 0x61, 0x5c, 0x43,
	...
	0x1c, 0x41, 0x72, 0x74, 0x65, 0x6c, 0x61, 0x3a, 0x3a, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x3a,
	0x3a, 0x45, 0x74, 0x68, 0x73, 0x65, 0x63, 0x70, 0x32, 0x35, 0x36, 0x6b, 0x31, 0x62, 0x06, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_artela_crypto_ethsecp256k1_keys_proto_rawDescOnce sync.Once
	file_artela_crypto_ethsecp256k1_keys_proto_rawDescData = file_artela_crypto_ethsecp256k1_keys_proto_rawDesc
)

func file_artela_crypto_ethsecp256k1_keys_proto_rawDescGZIP() []byte {
	file_artela_crypto_ethsecp256k1_keys_proto_rawDescOnce.Do(func() {
		file_artela_crypto_ethsecp256k1_keys_proto_rawDescData = protoimpl.X.CompressGZIP(file_artela_crypto_ethsecp256k1_keys_proto_rawDescData)
	})
	return file_artela_crypto_ethsecp256k1_keys_proto_rawDescData
}

var file_artela_crypto_ethsecp256k1_keys_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_artela_crypto_ethsecp256k1_keys_proto_goTypes = []interface{}{
	(*PubKey)(nil),  // 0: artela.crypto.ethsecp256k1.PubKey
	(*PrivKey)(nil), // 1: artela.crypto.ethsecp256k1.PrivKey
}
var file_artela_crypto_ethsecp256k1_keys_proto_depIdxs = []int32{
...
func init() { file_artela_crypto_ethsecp256k1_keys_proto_init() }
func file_artela_crypto_ethsecp256k1_keys_proto_init() {
	if File_artela_crypto_ethsecp256k1_keys_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_artela_crypto_ethsecp256k1_keys_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PubKey); i {
			case 0:
				return &v.state
			case 1:
		...
		file_artela_crypto_ethsecp256k1_keys_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_artela_crypto_ethsecp256k1_keys_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_artela_crypto_ethsecp256k1_keys_proto_goTypes,
		DependencyIndexes: file_artela_crypto_ethsecp256k1_keys_proto_depIdxs,
		MessageInfos:      file_artela_crypto_ethsecp256k1_keys_proto_msgTypes,
	}.Build()
	File_artela_crypto_ethsecp256k1_keys_proto = out.File
	file_artela_crypto_ethsecp256k1_keys_proto_rawDesc = nil
	file_artela_crypto_ethsecp256k1_keys_proto_goTypes = nil
	file_artela_crypto_ethsecp256k1_keys_proto_depIdxs = nil
}
