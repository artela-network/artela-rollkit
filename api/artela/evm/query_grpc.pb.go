...
const (
	Query_Account_FullMethodName          = "/artela.evm.Query/Account"
	Query_CosmosAccount_FullMethodName    = "/artela.evm.Query/CosmosAccount"
	Query_ValidatorAccount_FullMethodName = "/artela.evm.Query/ValidatorAccount"
	Query_Balance_FullMethodName          = "/artela.evm.Query/Balance"
	Query_Storage_FullMethodName          = "/artela.evm.Query/Storage"
	Query_Code_FullMethodName             = "/artela.evm.Query/Code"
	Query_Params_FullMethodName           = "/artela.evm.Query/Params"
	Query_EthCall_FullMethodName          = "/artela.evm.Query/EthCall"
	Query_EstimateGas_FullMethodName      = "/artela.evm.Query/EstimateGas"
	Query_TraceTx_FullMethodName          = "/artela.evm.Query/TraceTx"
...
func (c *queryClient) GetSender(ctx context.Context, in *MsgEthereumTx, opts ...grpc.CallOption) (*GetSenderResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_GetSender_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_GetSender_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_GetSender_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
