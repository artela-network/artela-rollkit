...
var (
	...
	fd_TxResult_sender              protoreflect.FieldDescriptor
)

func init() {
	file_artela_types_indexer_proto_init()
	md_TxResult = File_artela_types_indexer_proto.Messages().ByName("TxResult")
	...
	fd_TxResult_sender = md_TxResult.Fields().ByName("sender")
}
...
func (x *TxResult) slowProtoReflect() protoreflect.Message {
	mi := &file_artela_types_indexer_proto_msgTypes[0]
...
func (x *fastReflection_TxResult) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "artela.types.TxResult.height":
		return x.Height != int64(0)
	case "artela.types.TxResult.tx_index":
		return x.TxIndex != uint32(0)
	case "artela.types.TxResult.msg_index":
		return x.MsgIndex != uint32(0)
	case "artela.types.TxResult.eth_tx_index":
		return x.EthTxIndex != int32(0)
	case "artela.types.TxResult.failed":
		return x.Failed != false
	case "artela.types.TxResult.gas_used":
		return x.GasUsed != uint64(0)
	case "artela.types.TxResult.cumulative_gas_used":
		return x.CumulativeGasUsed != uint64(0)
	case "artela.types.TxResult.sender":
		return x.Sender != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: artela.types.TxResult"))
		}
		panic(fmt.Errorf("message artela.types.TxResult does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_TxResult) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message artela.types.TxResult does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_TxResult) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "artela.types.TxResult.height":
		panic(fmt.Errorf("field height of message artela.types.TxResult is not mutable"))
	case "artela.types.TxResult.tx_index":
		panic(fmt.Errorf("field tx_index of message artela.types.TxResult is not mutable"))
	case "artela.types.TxResult.msg_index":
		panic(fmt.Errorf("field msg_index of message artela.types.TxResult is not mutable"))
	case "artela.types.TxResult.eth_tx_index":
		panic(fmt.Errorf("field eth_tx_index of message artela.types.TxResult is not mutable"))
	case "artela.types.TxResult.failed":
		panic(fmt.Errorf("field failed of message artela.types.TxResult is not mutable"))
	case "artela.types.TxResult.gas_used":
		panic(fmt.Errorf("field gas_used of message artela.types.TxResult is not mutable"))
	case "artela.types.TxResult.cumulative_gas_used":
		panic(fmt.Errorf("field cumulative_gas_used of message artela.types.TxResult is not mutable"))
	case "artela.types.TxResult.sender":
		panic(fmt.Errorf("field sender of message artela.types.TxResult is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: artela.types.TxResult"))
		}
...
func (x *fastReflection_TxResult) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in artela.types.TxResult", d.FullName()))
	}
	panic("unreachable")
}
...
func (*TxResult) Descriptor() ([]byte, []int) {
	return file_artela_types_indexer_proto_rawDescGZIP(), []int{0}
}
...
func (x *TxResult) GetSender() string {
	if x != nil {
		return x.Sender
	}
	return ""
...
var File_artela_types_indexer_proto protoreflect.FileDescriptor

var file_artela_types_indexer_proto_rawDesc = []byte{
	,
	...
	,
}

var (
	file_artela_types_indexer_proto_rawDescOnce sync.Once
	file_artela_types_indexer_proto_rawDescData = file_artela_types_indexer_proto_rawDesc
)

func file_artela_types_indexer_proto_rawDescGZIP() []byte {
	file_artela_types_indexer_proto_rawDescOnce.Do(func() {
		file_artela_types_indexer_proto_rawDescData = protoimpl.X.CompressGZIP(file_artela_types_indexer_proto_rawDescData)
	})
	return file_artela_types_indexer_proto_rawDescData
}

var file_artela_types_indexer_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_artela_types_indexer_proto_goTypes = []interface{}{
	(*TxResult)(nil), // 0: artela.types.TxResult
}
var file_artela_types_indexer_proto_depIdxs = []int32{
...
func init() { file_artela_types_indexer_proto_init() }
func file_artela_types_indexer_proto_init() {
	if File_artela_types_indexer_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_artela_types_indexer_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_artela_types_indexer_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_artela_types_indexer_proto_goTypes,
		DependencyIndexes: file_artela_types_indexer_proto_depIdxs,
		MessageInfos:      file_artela_types_indexer_proto_msgTypes,
	}.Build()
	File_artela_types_indexer_proto = out.File
	file_artela_types_indexer_proto_rawDesc = nil
	file_artela_types_indexer_proto_goTypes = nil
	file_artela_types_indexer_proto_depIdxs = nil
}
