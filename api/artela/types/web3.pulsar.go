...
func init() {
	file_artela_types_web3_proto_init()
	md_ExtensionOptionsWeb3Tx = File_artela_types_web3_proto.Messages().ByName("ExtensionOptionsWeb3Tx")
...
func (x *ExtensionOptionsWeb3Tx) slowProtoReflect() protoreflect.Message {
	mi := &file_artela_types_web3_proto_msgTypes[0]
...
func (x *fastReflection_ExtensionOptionsWeb3Tx) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "artela.types.ExtensionOptionsWeb3Tx.typed_data_chain_id":
		return x.TypedDataChainId != uint64(0)
	case "artela.types.ExtensionOptionsWeb3Tx.fee_payer":
		return x.FeePayer != ""
	case "artela.types.ExtensionOptionsWeb3Tx.fee_payer_sig":
		return len(x.FeePayerSig) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: artela.types.ExtensionOptionsWeb3Tx"))
		}
		panic(fmt.Errorf("message artela.types.ExtensionOptionsWeb3Tx does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ExtensionOptionsWeb3Tx) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message artela.types.ExtensionOptionsWeb3Tx does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ExtensionOptionsWeb3Tx) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "artela.types.ExtensionOptionsWeb3Tx.typed_data_chain_id":
		panic(fmt.Errorf("field typed_data_chain_id of message artela.types.ExtensionOptionsWeb3Tx is not mutable"))
	case "artela.types.ExtensionOptionsWeb3Tx.fee_payer":
		panic(fmt.Errorf("field fee_payer of message artela.types.ExtensionOptionsWeb3Tx is not mutable"))
	case "artela.types.ExtensionOptionsWeb3Tx.fee_payer_sig":
		panic(fmt.Errorf("field fee_payer_sig of message artela.types.ExtensionOptionsWeb3Tx is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: artela.types.ExtensionOptionsWeb3Tx"))
		}
...
func (x *fastReflection_ExtensionOptionsWeb3Tx) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in artela.types.ExtensionOptionsWeb3Tx", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: artela/types/web3.proto
...
func (*ExtensionOptionsWeb3Tx) Descriptor() ([]byte, []int) {
	return file_artela_types_web3_proto_rawDescGZIP(), []int{0}
}
...
var File_artela_types_web3_proto protoreflect.FileDescriptor

var file_artela_types_web3_proto_rawDesc = []byte{
	0x0a, 0x17, 0x61, 0x72, 0x74, 0x65, 0x6c, 0x61, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x77,
	0x65, 0x62, 0x33, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x61, 0x72, 0x74, 0x65, 0x6c,
	0x61, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x1a, 0x14, 0x67, 0x6f, 0x67, 0x6f, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf5, 0x01,
	0x0a, 0x16, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x4f, 0x70, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x57, 0x65, 0x62, 0x33, 0x54, 0x78, 0x12, 0x61, 0x0a, 0x13, 0x74, 0x79, 0x70, 0x65,
	...
	0x74, 0x79, 0x52, 0x0b, 0x66, 0x65, 0x65, 0x50, 0x61, 0x79, 0x65, 0x72, 0x53, 0x69, 0x67, 0x3a,
	0x04, 0x88, 0xa0, 0x1f, 0x00, 0x42, 0x8d, 0x01, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x72,
	0x74, 0x65, 0x6c, 0x61, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x42, 0x09, 0x57, 0x65, 0x62, 0x33,
	...
	0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0xa2, 0x02, 0x03, 0x41, 0x54, 0x58, 0xaa, 0x02, 0x0c, 0x41,
	0x72, 0x74, 0x65, 0x6c, 0x61, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x73, 0xca, 0x02, 0x0c, 0x41, 0x72,
	0x74, 0x65, 0x6c, 0x61, 0x5c, 0x54, 0x79, 0x70, 0x65, 0x73, 0xe2, 0x02, 0x18, 0x41, 0x72, 0x74,
	0x65, 0x6c, 0x61, 0x5c, 0x54, 0x79, 0x70, 0x65, 0x73, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74,
	0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0d, 0x41, 0x72, 0x74, 0x65, 0x6c, 0x61, 0x3a, 0x3a,
	0x54, 0x79, 0x70, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_artela_types_web3_proto_rawDescOnce sync.Once
	file_artela_types_web3_proto_rawDescData = file_artela_types_web3_proto_rawDesc
)

func file_artela_types_web3_proto_rawDescGZIP() []byte {
	file_artela_types_web3_proto_rawDescOnce.Do(func() {
		file_artela_types_web3_proto_rawDescData = protoimpl.X.CompressGZIP(file_artela_types_web3_proto_rawDescData)
	})
	return file_artela_types_web3_proto_rawDescData
}

var file_artela_types_web3_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_artela_types_web3_proto_goTypes = []interface{}{
	(*ExtensionOptionsWeb3Tx)(nil), // 0: artela.types.ExtensionOptionsWeb3Tx
}
var file_artela_types_web3_proto_depIdxs = []int32{
...
func init() { file_artela_types_web3_proto_init() }
func file_artela_types_web3_proto_init() {
	if File_artela_types_web3_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_artela_types_web3_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_artela_types_web3_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_artela_types_web3_proto_goTypes,
		DependencyIndexes: file_artela_types_web3_proto_depIdxs,
		MessageInfos:      file_artela_types_web3_proto_msgTypes,
	}.Build()
	File_artela_types_web3_proto = out.File
	file_artela_types_web3_proto_rawDesc = nil
	file_artela_types_web3_proto_goTypes = nil
	file_artela_types_web3_proto_depIdxs = nil
}
