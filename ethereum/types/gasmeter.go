...
func NewInfiniteGasMeterWithLimit(limit gas.Gas) gas.Meter {
...
func (g *infiniteGasMeterWithLimit) GasConsumed() gas.Gas {
	return g.consumed
}
...
func (g *infiniteGasMeterWithLimit) GasConsumedToLimit() gas.Gas {
	return g.consumed
}

// Limit returns the gas limit of the GasMeter.
func (g *infiniteGasMeterWithLimit) Limit() gas.Gas {
	return g.limit
}
...
func (g *infiniteGasMeterWithLimit) ConsumeGas(amount gas.Gas, descriptor string) {
	var overflow bool
...
func (g *infiniteGasMeterWithLimit) RefundGas(amount gas.Gas, descriptor string) {
...
func (g *infiniteGasMeterWithLimit) GasRemaining() gas.Gas {
